...
import com.borqs.se.weather.LocationState.Locate;

public class BDLocate implements Locate {
    private static final String TAG = "Weather_BDLocate";
    private static boolean DEBUG = SEHomeUtils.DEBUG;
    ...
    private void reqCityFromBaiduServer() {
        mBDLocationClient = LauncherApplication.getInstance().getBDLocationClient();
        ...
        mBDLocationClientOption.setProdName(SEHomeUtils.TAG);

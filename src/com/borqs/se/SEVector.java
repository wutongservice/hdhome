...
public class SEVector {
	...
	public static final int INVALID_PLANE = 0;
    public static float roundFloat(float target, float start, float end) {
        if (start == end) {
            target = end;
        } else {
            if (start < end) {
    ...
    public static SEVector3f roundVector(SEVector3f target, SEVector3f start, SEVector3f end) {
        if (start.equals(end)) {
            target = end;
        } else {
            final int len = target.mD.length;
            for (int i = 0; i < len; i++) {
                target.mD[i] = roundFloat(target.mD[i], start.mD[i], end.mD[i]);
            }
        }
        return target;
    }
    ...
    public static class SEVector3f {
        ...
        public static SEVector3f ZERO = new SEVector3f(0, 0, 0);
        public SEVector3f() {
        ...
        public SEVector3f(String x, String y, String z)
        {
        	mD[0] = Float.parseFloat(x);
        	mD[1] = Float.parseFloat(y);
        	mD[2] = Float.parseFloat(z);
        }
        public float getX() {
            return mD[0];
        }
        ...
        public float dot(SEVector3f v) {
        	    return mD[0] * v.mD[0] + mD[1] * v.mD[1] + mD[2] * v.mD[2];
        }
        public boolean isZero() {
            return (mD[0] == 0 && mD[1] == 0 && mD[2] == 0);
        }
        public double thetaBetween(SEVector3f v) {
        	    double cos = this.dot(v) / (this.getLength() * v.getLength());
        	    return Math.acos(cos);
        }
        public float dist(SEVector3f t) {
        	    float a = (mD[0] - t.mD[0]) * (mD[0] - t.mD[0]);
			float b = (mD[1] - t.mD[1]) * (mD[1] - t.mD[1]);
			float c = (mD[2] - t.mD[2]) * (mD[2] - t.mD[2]);
        ...
        public static SEVector3f parseFrom(String str) {
            return new SEVector3f(ProviderUtils.getFloatArray(str, AXIS_NUM));
        }
    }
    ...
    public static class SERotate {
        ...
        public SERotate(String angle, String x, String y, String z)
        {
        	mD[0] = Float.parseFloat(angle);
        	mD[1] = Float.parseFloat(x);
        	mD[2] = Float.parseFloat(y);
        	mD[3] = Float.parseFloat(z);
        }
    ...
    public static class SEVector4i {
        ...
        public SEVector4i(SEVector3i vector4i) {
            mD[0] = vector4i.mD[0];
            mD[1] = vector4i.mD[1];
            mD[2] = vector4i.mD[2];
            mD[3] = vector4i.mD[3];
    ...
    public static class SECommonID {
        public int[] mID = { 0, 0, 0, 0 };
        ...
        public void create() {
            mID[0] = (int) (Math.random() * 1000.0f);
            mID[1] = (int) (Math.random() * 1000.0f);
            mID[2] = (int) (Math.random() * 1000.0f);
            mID[3] = (int) (Math.random() * 1000.0f);
        }

        public SECommonID(int id0, int id1, int id2, int id3) {
            mID[0] = id0;
            mID[1] = id1;
            mID[2] = id2;
            mID[3] = id3;
    ...
    public static class SERect3D {
        ...
        public void setTexCoord(float minx, float miny, float maxx, float maxy) {
            mMinTexX = minx;
            mMinTexY = miny;
    ...
    public static class SERay {
        ...
        public void setDirection(SEVector3f d) {
        	    mDirection = d;
        }
        public void setLocation(SEVector3f p) {
        	    mLocation = p;
        }
    }

...
public class LauncherModel extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        } else if (LauncherApplication.ACTION_INSTALL_SHORTCUT.equals(intent.getAction())
                || LauncherApplication.ACTION_UNINSTALL_SHORTCUT.equals(intent.getAction())) {
    ...
    private class PackageUpdatedTask implements Runnable {
        ...
        public void run() {
            ...
            case OP_AVAILABLE:
                ...
                break;
            case OP_LOADALL:
                SESceneManager.getInstance().debugOutput("LauncherModel OP_LOADALL enter.");
                mAllAppsList.clear();
                mAllAppsList.loadAll();
                SESceneManager.getInstance().debugOutput("LauncherModel OP_LOADALL loaded.");
                updateAll();
                SESceneManager.getInstance().debugOutput("LauncherModel OP_LOADALL updated.");
                ...
                mHasLoaded = true;
                SESceneManager.getInstance().debugOutput("LauncherModel OP_LOADALL exit.");
                return;
            }
    ...
    private ArrayList<ShortcutItemInfo> mShortcuts = new ArrayList<ShortcutItemInfo>();
    ...
    private void updateAll() {
        synchronized (mLock) {
            ...
            mShortcuts = new ArrayList<ShortcutItemInfo>();
            ...
            for (ItemInfo item : mAllDatas) {
                ...
                } else if (item.mItemType == ItemInfo.ITEM_TYPE_SHORTCUT) {
                    mShortcuts.add((ShortcutItemInfo) item);
    ...
    public ArrayList<ShortcutItemInfo> getShortcuts() {
        synchronized (mLock) {
            return mShortcuts;
        }
    }

...
public class SEObjectData {
    ...
    public TransParas mLocalTransParas;
    public TransParas mUserTransParas;
    ...
    public SEObjectData(String name) {
        ...
        mLocalTransParas = new TransParas();
    ...
    public float[] getTexVertexArray() {
        if (!mHasResizeImage) {
            mHasResizeImage = true;
            int power2Width = SEHomeUtils.higherPower2(mImageWidth);
            int power2Height = SEHomeUtils.higherPower2(mImageHeight);

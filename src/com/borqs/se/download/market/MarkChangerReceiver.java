...
public class MarkChangerReceiver extends BroadcastReceiver {
                ...
                new Thread(){
                    ...
                    public void run() {
                        ...
                        if  ( cursor != null && cursor.moveToFirst()) {
                            ...
                            String product_id = SEHomeUtils.PKG_CURRENT_NAME + "." + themeName;
...
//                            MarketUtils.deletePlugIn(context, product_id);
                ...
                new Thread() {
                    ...
                    public void run() {
                        ...
                        fileLocal.delete();
//                        String product_id = SEHomeUtils.PKG_CURRENT_NAME + "." + info.mName;
//                        MarketUtils.deletePlugIn(context, product_id);
                        MarketUtils.deletePlugIn(context, productId);
                    }

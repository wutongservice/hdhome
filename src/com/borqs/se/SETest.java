...
public class SETest extends Activity{
        ...
        button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                // Perform action on click
            	    Log.i(TAG, "## click ##");
            	    SE3DScene currentScene = SESceneManager.getInstance().getCurrentScene();
    ...
    private void handleCommand(SE3DScene scene, String command, String contentText) {
    ...
    private void addNewDock(SE3DScene scene, SEObject parent, String name) {
        ...
        NormalObject object = SEHomeUtils.getObjectByClassName(scene, objectInfo);

...
import com.borqs.se.GLSurfaceView;
        ...
        public EGLSurface createWindowSurface(EGL10 egl, EGLDisplay display, EGLConfig config, Object nativeWindow) {
            ...
            while (result == null && mTryCount < 5) {
                ...
                try {
                    ...
                    Log.e(SEHomeUtils.TAG, "eglCreateWindowSurface", e);
                }
                if (result == null) {
                    try {
    ...
    private class Renderer implements GLSurfaceView.Renderer {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            if (SEHomeUtils.DEBUG)
                Log.d(SEHomeUtils.TAG, "#### Surface created ####");
            mSESceneManager.initRenderCapabilities_JNI();
        }

        public void onSurfaceChanged(GL10 gl, int width, int height) {
            if (SEHomeUtils.DEBUG)
                Log.d(SEHomeUtils.TAG, "#### Surface changed ####");

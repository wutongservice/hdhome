    ...
    public static boolean onMenuItemClicked(int index) {
        switch (index) {
            case 0:
            	...
            	SEHomeUtils.initLocalObject(context);
...
//            		SESceneManager.getInstance().getCurrentScene().handleMessage(SE3DHomeScene.MSG_TYPE_SHOW_OBJECT_VIEW, null);
                break;
            case 1:
                SEHomeUtils.showWallpapers(SESceneManager.getInstance().getContext());
                break;
            case 2:
                Intent intentHome = new Intent();
                intentHome.setAction(SEHomeUtils.HOME_SETTING_ACTION);

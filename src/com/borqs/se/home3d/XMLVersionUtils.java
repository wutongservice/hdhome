...
//                Log.d(SEHomeUtils.TAG, "upgradeSlot face : " + i);
...
//                            if (span != null) {
//                                if (SEHomeUtils.DEBUG)
//                                    Log.d(SEHomeUtils.TAG, "name : " + name + " | " + id + " | new span : " + span[0]
//                                            + ", " + span[1]);
...
//                if (widget != null) {
//                    newSpan = SEHomeUtils.getSpanForWidget(context, widget);
//                }
//            }
//        }
//        return newSpan;

...
public class WallLongClickDialog extends Dialog {

    private android.view.View.OnClickListener mOnItemClickListener;
    
    private View mRootView;
    private Context mContext;
    public WallLongClickDialog(Context context, android.view.View.OnClickListener listener) {
    ...
    public void onWindowFocusChanged(boolean hasFocus) {
    	...
    	Log.d("WallLongClickDialog: ", "dm.density: " + dm.density) ;

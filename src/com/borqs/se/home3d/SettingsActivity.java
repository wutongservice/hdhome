...
//            display.removePreference(mOrientationListPreference);
    ...
    public boolean onPreferenceClick(Preference preference) {
        /*if (preference.getKey().equals(KEY_UPGRADE_VIEW)) {
            ...
            intent.putExtra(Intent.EXTRA_TEXT, getString(R.string.share_content, getChannelSharedContent(), SEHomeUtils.PKG_CURRENT_NAME));
            intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
            try {
                startActivity(intent);
            }catch (ActivityNotFoundException e) {
            ...
            SEHomeUtils.showWallpapers(this);
    ...
    private String getScoreContent() {
        ...
        if (getString(R.string.channel_amazon).equalsIgnoreCase(channelCode)) {
            return getString(R.string.share_content_link_amazon) + "=" + SEHomeUtils.PKG_CURRENT_NAME + "&showAll=1";
        }
    ...
    public boolean onPreferenceChange(Preference preference, Object objValue) {
        if (preference.getKey().equals(KEY_FPS)) {
            ...
            final SE3DScene scene =  sceneManager.getCurrentScene();
...
//    }
    ...
    public static void checkOrientationSettings(SEHomeActivity activity) {
...
//        }
    ...
    public static void updateScreenIndicatorStatus(Object objValue) {
        ...
        SESceneManager.getInstance().removeMessage(SE3DHomeScene.MSG_TYPE_SHOW_SCREEN_INDICATOR);
        SESceneManager.getInstance().handleMessage(SE3DHomeScene.MSG_TYPE_SHOW_SCREEN_INDICATOR, objValue);
    }

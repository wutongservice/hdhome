...
import com.borqs.se.XmlUtils.AnalysisException;
...
//    }
    ...
    public static int searchMaxIndex(SE3DScene scene, Uri uri, String name) {
    ...
    public static int searchMaxIndex(SE3DScene scene, String table, String name) {
        String where = ObjectInfoColumns.SCENE_NAME + "='" + scene.mSceneName + "' AND "
                + ObjectInfoColumns.OBJECT_NAME + "='" + name + "'";
        Context context = SESceneManager.getInstance().getContext();
        Cursor cursor = SEHomeDataBaseHelper
                .getInstance(context)
                .getReadableDatabase()

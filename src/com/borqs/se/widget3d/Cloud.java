...
import com.borqs.se.home3d.LunarCalendar;
...
import com.borqs.se.object3d.SEParticleSystem;
...
import com.borqs.se.weather.LoopForInfoService.WeatherUpdateCallBack;
import com.borqs.se.weather.WeatherConditions;
import com.borqs.se.weather.WeatherSettings;
import com.borqs.se.weather.yahoo.WeatherInfo;
...
public class Cloud extends NormalObject implements WeatherUpdateCallBack, CameraChangedListener {
    ...
    public Cloud(SE3DScene scene, String name, int index) {
...
//            }
    ...
    private void processWeather_changed(int type, boolean isNight) {
        ...
        if (SEHomeUtils.DEBUG)
            Log.d(SEHomeUtils.TAG, "####sky processWeather_changed ####");
    ...
    private class UpdateSkyAnimation extends CountAnimation {
        ...
        public UpdateSkyAnimation(SE3DScene scene, boolean isNight) {
            super(scene);
            mNight = isNight;
            mCount = 0;
        }
    ...
    private class SkyObject extends SEObject {
        ...
        public SkyObject(SE3DScene scene, String name) {
            super(scene, name);

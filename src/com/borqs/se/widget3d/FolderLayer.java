...
public class FolderLayer extends VesselLayer {
    ...
    public FolderLayer(SE3DScene scene, VesselObject vesselObject) {
    ...
    private void playSlotAnimation(final ObjectSlot wallSlot, final SEAnimFinishListener l) {
        ...
        final TransParas desTransParas = mFolder.getSlotTransParas(getOnMoveObject().getObjectInfo(), getOnMoveObject());
    ...
    private class SetScaleAnimation extends CountAnimation {
        ...
        public SetScaleAnimation(SE3DScene scene, SEObject obj, float end, float step) {
            super(scene);
            mObject = obj;
            mEndScale = end;
            mStep = step;

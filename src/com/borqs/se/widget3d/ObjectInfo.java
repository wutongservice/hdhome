...
//        }
    ...
    public ResolveInfo getResolveInfo() {
        ...
        if (mResolveInfo == null) {
            mResolveInfo = SEHomeUtils.findResolveInfoByComponent(mContext, mComponentName);
        }
        return mResolveInfo;
    }
    ...
    public Intent getIntent() {
    	...
    	if(mComponentName != null && SEHomeUtils.LOCKSCREEN_HOMEHD_PKG.equals(mComponentName.getPackageName())) {
        ...
        if (mShortcutUrl != null) {
        	...
        	if(mComponentName != null) {
        		if(mContext.getPackageName().equals(mComponentName.getPackageName())) { // hard code to start search activity
        			...
        			if(SEHomeUtils.LOCKSCREEN_HOMEHD_PKG.equals(mComponentName.getPackageName()) && !haveApp) { // hard code to recommend lockScreenHD
        				mIntent = new Intent(Intent.ACTION_VIEW,
                                Uri.parse("market://search?q=pname:" + SEHomeUtils.LOCKSCREEN_HOMEHD_PKG));
        				mIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_RESET_TASK_IF_NEEDED);
        			}else {
            ...
            public void run() {
                ...
                if (!onlyName) {
                    ...
                    if (mShortcutIcon != null) {
                        SEHomeUtils.writeBitmap(values, mShortcutIcon.getBitmap());

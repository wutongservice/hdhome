...
public abstract class VesselObject extends NormalObject implements AppCallBack {
    ...
    public VesselObject(SE3DScene scene, String name, int index) {
    ...
    public abstract TransParas getSlotTransParas(ObjectInfo objectInfo, NormalObject object);
        ...
        if (cursor != null) {
            while (cursor.moveToNext()) {
                ...
                if (objectInfo.isValidateMountPointData(chain)) {
                    ...
                    NormalObject object = SEHomeUtils.getObjectByClassName(getScene(), objectInfo);

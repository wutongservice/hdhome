...
//import com.borqs.se.object3d.SEObject.PRESS_TYPE;
...
//        return "com.borqs.selockscreen";
        return SEHomeUtils.LOCKSCREEN_HOMEHD_PKG;
    }

    public Flyer(SE3DScene scene, String name, int index) {
...
//        }
    ...
    public void stopFlyDelayed(long delayed) {
        LoadResThread.getInstance().cancel(mStopFlyTask);
        LoadResThread.getInstance().process(mStopFlyTask, delayed);
    }
    ...
    public class MoveAnimation extends CountAnimation {
        ...
        public MoveAnimation(SE3DScene scene) {
            super(scene);
        }

        public MoveAnimation(SE3DScene scene, AnimationInfo info) {
            this(scene);
            mAnimationInfo = info;
        }

...
public class Folder extends VesselObject {
    ...
    public Folder(SE3DScene scene, String name, int index) {
    ...
    private void showExpand() {
        if (!mOnDialogShow) {
            ...
            TransParas srcTransParas = new TransParas();
            ...
            TransParas desTransParas = new TransParas();
    ...
    private void hideExpand(boolean fast, final SEAnimFinishListener l) {
        if (mOnDialogShow) {
            ...
            if (fast) {
                ...
                TransParas srcTransParas = mDialog.getUserTransParas().clone();
                TransParas desTransParas = new TransParas();
    ...
    private class ShowDialogFolderAnimation extends CountAnimation {
        ...
        public ShowDialogFolderAnimation(SE3DScene scene, SEObject obj, TransParas srcTransParas,
    ...
    public TransParas getFirstPosition() {
    ...
    private class FolderExpandDialog extends SEObjectGroup {
        ...
        public FolderExpandDialog(SE3DScene scene, String name, int index) {
            super(scene, name, index);
        ...
        public TransParas getSlotTransParas(ObjectInfo objectInfo) {
        ...
        private class MovePositionAnimation extends CountAnimation {
            ...
            public MovePositionAnimation(SE3DScene scene, NormalObject obj, SEVector3f srcLocation,
        ...
        private class ConflictAnimation extends CountAnimation {
            ...
            public ConflictAnimation(SE3DScene scene, List<ConflictAnimationTask> conflictAnimationTasks, int count) {
                super(scene);
                mCount = count;

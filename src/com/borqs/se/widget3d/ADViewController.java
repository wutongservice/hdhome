...
public class ADViewController implements CameraChangedListener {
    ...
    public void setSEScene(SE3DScene scene) {
        mScene = scene;
    }
            ...
            public void onLoadADS(int index) {
                if (index == TYPE_ADMOD) {
                    if (SEHomeUtils.DEBUG) {
                        Log.d(SEHomeUtils.TAG, "request loadAdmob");
                    }
                    enqueueAdRequest();
    ...
    private void initADMod() {
        ...
        if (SEHomeUtils.DEBUG) {
            Log.d(SEHomeUtils.TAG, "init Admob");
        }
        mADViewIntegrated.addView(admod, TYPE_ADMOD);
        admod.setAdListener(new com.google.ads.AdListener() {

            public void onDismissScreen(Ad arg0) {
                MobclickAgent.onEvent(mContext, "ADMOB_DISMISS_AD", arg0.toString());
            }

            public void onFailedToReceiveAd(Ad arg0, ErrorCode arg1) {
                if (SEHomeUtils.DEBUG) {
                    Log.d(SEHomeUtils.TAG, "onFailedToReceiveAdmob");
                }
                MobclickAgent.onEvent(mContext, "ADMOB_FAILED_TO_RECEIVE_AD", arg0.toString() + arg1.toString());
            ...
            public void onLeaveApplication(Ad arg0) {
                MobclickAgent.onEvent(mContext, "ADMOB_LEAVE_APP", arg0.toString());
            }

            public void onPresentScreen(Ad arg0) {
                MobclickAgent.onEvent(mContext, "ADMOB_PRESENT_AD", arg0.toString());
            }

            public void onReceiveAd(Ad arg0) {
                if (SEHomeUtils.DEBUG) {
                    Log.d(SEHomeUtils.TAG, "onReceiveAdmob");
                }
                MobclickAgent.onEvent(mContext, "ADMOB_RECEIVED_AD", arg0.toString());
    ...
    private void deleteAD() {
        if (mADViewIntegrated != null) {
            if (SEHomeUtils.DEBUG) {
                Log.d(SEHomeUtils.TAG, "delete Admob");
            }
            MobclickAgent.onEvent(mContext, "ADMOB_DESTROY_AD", "" + System.currentTimeMillis());
            stopAD();
            com.google.ads.AdView admod = (AdView) mADViewIntegrated.getChildAt(TYPE_ADMOD);
            ...
            if (null != mADViewIntegrated) {
                ...
                synchronized (mRequestLock) {
                    if (isNetworkingAvailable()) {
                        ...
                        mIsRequesting = true;
                        MobclickAgent.onEvent(mContext, "ADMOB_REQUEST_AD", "" + System.currentTimeMillis());
    ...
    public void onCameraChanged() {
        if ((mScene.getCamera().isSkySight()) && !isFly) {
            isFly = true;
            ...
            if (modelInfo != null) {
                ...
                mCurrentFlyer = (Flyer) SEHomeUtils.getObjectByClassName(mScene, objInfo);
...
//        SEHomeUtils.reportError(errorMsg);
//        Log.e(TAG, errorMsg);
    }
    ...
    void complain(String message, boolean alert) {
        ...
        SEHomeUtils.reportError(TAG + "**** IAB Error: " + message);
        if (alert) {

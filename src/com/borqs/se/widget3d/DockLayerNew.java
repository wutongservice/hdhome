...
import com.borqs.se.widget3d.IconBox;
...
public class DockLayerNew extends DockAbstractLayer {
    ...
    public DockLayerNew(SE3DScene scene, VesselObject vesselObject) {
    ...
    public boolean onObjectMoveEvent(ACTION event, float x, float y) {
        ...
        */
        ...
        case BEGIN:
            ...
            TransParas ttt = desTransParas.clone();
    ...
    private void setMovePoint(int touchX, int touchY) {
        ...
        mObjectTransParas = new TransParas();

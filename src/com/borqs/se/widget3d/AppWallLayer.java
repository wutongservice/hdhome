...
public class AppWallLayer extends VesselLayer {
    ...
    public AppWallLayer(SE3DScene scene, VesselObject vesselObject) {
    ...
    private void playSlotAnimation(final ObjectSlot wallSlot, final SEAnimFinishListener l) {
        ...
        final TransParas desTransParas = mAppWall.getSlotTransParas(getOnMoveObject().getObjectInfo(), getOnMoveObject());

...
public class WidgetObject extends NormalObject {
    ...
    public boolean load(final SEObject parent, final Runnable finish) {
        LoadResThread.getInstance().process(new Runnable() {
            public void run() {
                ...
                Bitmap icon = SEHomeUtils.createEmptyBitmap(SEHomeUtils.higherPower2(realW),
                        SEHomeUtils.higherPower2(realH));
    ...
    private TransParas getBackgroundLocation() {
        ...
        transparas.mTranslate.set(-25, SEHomeUtils.ICON_BACKGROUND_SPACING, -5);
    ...
    public WidgetObject(SE3DScene scene, String name, int index) {

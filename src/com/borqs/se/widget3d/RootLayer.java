...
public class RootLayer extends VesselLayer {
    ...
    public RootLayer(SE3DScene scene, VesselObject vesselObject) {
    ...
    private static TransParas rayCrossWall(House house, SEVector.SERay ray, float wallRadius) {
    ...
    private void loadAndShowRecycle(VesselLayer currentLayer) {
        ...
        float scale;
        boolean onDeskSight = getScene().getStatus(SE3DScene.STATUS_ON_DESK_SIGHT);
...
//            scale = 0.8f;
    ...
    private class MoveObjectAnimation extends CountAnimation {
        ...
        public MoveObjectAnimation(SE3DScene scene, SEObject normalObject, SEVector3f srcLocation,

...
/*
static jstring se_getSelectedObjectString(JNIEnv* env, jobject object, jint x, jint y, jobjectArray objStringArray)
{
    jstring name = (jstring)env->GetObjectField(object, sceneNameID);
    const char* name8 = env->GetStringUTFChars(name, 0);
    SE_Scene* scene =  findScene(name8);
    if (scene)
    {
...
static const char *classPathName = "com/borqs/se/object3d/SECamera";
...
static JNINativeMethod methods[] = {
  ...
  {"getSelectedObject_JNI", "(II)Lcom/borqs/se/object3d/SEObject;", (void*)se_getSelectedObject},
  //{"getSelectedObjectString_JNI", "(II[Ljava/lang/String;)V", (void*)se_getSelectedObjectString}
};
    ...
    JNINativeMethod* gMethods, int numMethods)
{
    ...
    classObject =  env->FindClass("com/borqs/se/object3d/SEObject");

...
static const char *classPathName = "com/borqs/se/scene/SESceneManager";
...
static void invoke_javaCallback(int msgType, const char* msgName) 
{
    ...
    env->CallVoidMethod(mjavaApp, method_javaCallback, msgType, msg_name);
...
static void se_instance(JNIEnv* env, jobject obj, jint userid0, jint userid1)
{
    ...
    method_javaCallback = env->GetMethodID(clazz, "javaCallback", "(ILjava/lang/String;)V");
...
static void se_enableShadow(JNIEnv* env, jobject clazz, jint status)
{   
    bool en;
    if(status == 0)
    {
    ...
    SE_Application::getInstance()->setEnableShadow(en);
}
...
static JNINativeMethod methods[] = {
    ...
    {"enableShadow_JNI","(I)V",(void*)se_enableShadow},
